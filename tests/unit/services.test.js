...
describe('Фильтрация и поиск заказов', () => {
    ...
    test('TC-33: Должен фильтровать заказы по диапазону цен', () => {
        const filtered = filterByPriceRange(mockOrders, 1500, 2500);
        expect(filtered).toHaveLength(2);
        expect(filtered.every(o => o.price >= 1500 && o.price <= 2500)).toBe(true);
    });
